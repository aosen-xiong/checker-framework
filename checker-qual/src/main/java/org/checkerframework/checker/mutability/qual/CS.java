 ...
 * receiver.
 *
 * <p>Compared with {@link AS}, {@link Assignable} acts as receiver-dependent assignable inside the
 * method body, so the method preserves every field of each {@code @Immutable} object that exists
 * when it starts.
 *
